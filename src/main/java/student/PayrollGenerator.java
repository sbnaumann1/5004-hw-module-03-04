...
public final class PayrollGenerator {
    ...
    public static void main(String[] args) {
        ...
        // https://stackoverflow.com/questions/... link too long for style check
        Set<String> employeeIDs = new HashSet<>(
                timeCardList.stream().map(e -> e.getEmployeeID()).collect(Collectors.toList()));
        ...
        for (int i = 0; i < timeCardList.size(); i++) {
            ...
            if (hoursWorked < 0) { // skip negative time cards
                ...
                System.out.println(
                        "Zero hours worked for employee ID: " + employee + ". Generating pay stub with zero pay.");
